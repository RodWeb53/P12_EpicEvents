"""Module views pour la modification des contrats"""
from utils.clean_screen import clear
from rich.console import Console
from rich.table import Table


class UpdateContractMenuView:
    """Update contrat menu views"""
    ...
    def _display_menu(self):
        clear()
        print("")
        table = Table(title="Menu modification des contrats", width=80, style="green", show_lines=True)
